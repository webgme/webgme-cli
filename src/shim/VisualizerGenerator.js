...
WebGMEVisualizerGenerator = requirejs(
  "coreplugins/VisualizerGenerator/VisualizerGenerator"
);
...
_.extend(
  VisualizerGenerator.prototype,
  PluginShim.prototype,
  WebGMEVisualizerGenerator.prototype
);

// Helper function
VisualizerGenerator.prototype._fixFilePaths = function (file) {
  file.name = file.name.replace(
    /^src\/client\/js\/Widgets/,
    "src/visualizers/widgets"
  );
  file.name = file.name.replace(
    /^src\/client\/js\/Panels/,
    "src/visualizers/panels"
  );
