...
var spawn = require('child_process').spawn,
    ...
    cliCalls = ['init', 'start', 'new', 'add', 'rm', 'ls', 'enable', 'disable', 'new layout', 'add layout', 'rm layout', 'ls layout', 'enable layout', 'disable layout', 'new decorator', 'add decorator', 'rm decorator', 'ls decorator', 'enable decorator', 'disable decorator', 'new addon', 'add addon', 'rm addon', 'ls addon', 'enable addon', 'disable addon', 'new plugin', 'add plugin', 'rm plugin', 'ls plugin', 'enable plugin', 'disable plugin', 'new viz', 'add viz', 'rm viz', 'ls viz', 'enable viz', 'disable viz', 'new seed', 'add seed', 'rm seed', 'ls seed'].map(function (args) {
    return args + ' --help';
});
