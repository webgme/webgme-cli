...
define(['addon/AddOnBase'], function (AddOnBase) {
    ...
    'use strict';
    var MyAddon = function MyAddon(Core, storage, gmeConfig, logger, userId) {
    ...
    MyAddon.prototype.update = function (root, callback) {
        this.logger.info('MyAddon', new Date().getTime(), 'update', this.core.getGuid(root), this.core.getHash(root));
