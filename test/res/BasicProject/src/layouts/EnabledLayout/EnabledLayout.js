...
define(['lib/jquery/' + (DEBUG ? 'jquery.layout' : 'jquery.layout.min'), 'js/logger', 'text!./templates/EnabledLayout.html', 'text!./EnabledLayoutConfig.json'], function (_jQueryLayout, Logger, defaultLayoutTemplate, LayoutConfigJSON) {
    'use strict';
    ...
    var EnabledLayout = function EnabledLayout(params) {
        this._logger = params && params.logger || Logger.create('gme:Layouts:EnabledLayout', WebGMEGlobal.gmeConfig.client.log);
