module.exports = [
  {
    ...
    regexMessage:
      "No spaces and special characters allowed. This value is used as the name of the generated plugin class.",
  ...
  },
  {
    ...
    description:
      "Ejs template for code generation, also illustrates how to save artifacts using the blobClient.",
    value: "None",
    valueType: "string",
    valueItems: ["None", "JavaScript", "Python", "CSharp"],
    readOnly: false,
  },
  {
    ...
    description:
      "Configuration structure will populate this GUI with controls.",
    value: false,
    valueType: "boolean",
    readOnly: false,
  },
