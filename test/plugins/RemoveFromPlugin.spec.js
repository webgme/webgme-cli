...
describe("RemoveFromPlugin", function () {
  ...
  var executePluginAndGetCore = function (context, callback) {
    ...
    manager.executePlugin(pluginName, pluginConfig, context, function (
      err,
      pluginResult
    ) {
      ...
      context.project
        .getBranchHash(context.branchName)
  ...
  before(function (done) {
    ...
    testFixture
      .clearDBAndGetGMEAuth(gmeConfig, projectName)
      ...
      .then(function () {
        var importParam = {
          projectSeed: path.join(
            testFixture.MY_SEED_DIR,
            "EmptyWithTestPlugin.webgmex"
          ),
